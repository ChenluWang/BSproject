      ...
      <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
        <div class="row">
          ...
          <div class="col-sm-9">
            ...
            <!-- Location -->
            <h4 v-if="user.last_seen" class="h6 g-font-weight-300 g-mb-10">
              <i class="icon-eye g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> Location : {{ user.location }}
            </h4>
            <!-- End Location -->
            <br>
            <h4 v-if="user.last_seen" class="h6 g-font-weight-300 g-mb-10">
              <i class="icon-eye g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> What's up:
            </h4>
            <div v-if="user.about_me">
              <p class="lead g-line-height-1_8 g-pa-20 "> {{ user.about_me }}</p>
            </div>
